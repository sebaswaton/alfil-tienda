"""Create or reset the catalog administrator from cPanel's Run Script action."""
...
def main():
    ...
    full_name = os.getenv("ADMIN_INITIAL_FULL_NAME", "Administrador de catálogo").strip()
    ...
    try:
        ...
        user.full_name = full_name or "Administrador de catálogo"
